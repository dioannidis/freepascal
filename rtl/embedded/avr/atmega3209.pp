...
procedure TCB3_INT_ISR; external name 'TCB3_INT'; // Interrupt 36 TCB3
procedure USART3_RXC_ISR; external name 'USART3_RXC'; // Interrupt 37 USART3
procedure USART3_DRE_ISR; external name 'USART3_DRE'; // Interrupt 38 USART3
procedure USART3_TXC_ISR; external name 'USART3_TXC'; // Interrupt 39 USART3
